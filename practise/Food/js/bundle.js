...
function cards() {
    ...
    // axios.get("http://localhost:3000/menu").then((dataget) => {
    //     dataget.data.forEach(({ img, altimg, title, descr, price }) => {
    //         new MenuCard(
    //             img,
    //             altimg,
    //             title,
...
function tabs(
    ...
    const tabs = document.querySelectorAll(tabsSelector),
        ...
        tabsParent = document.querySelector(tabsParentSelecotr);
